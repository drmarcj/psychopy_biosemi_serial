...
expName = 'triggerDemo'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\lrcn_lab\\Documents\\Marc EEG demo\\triggerDemo_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('triggers.xlsx'),
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() < 1.0:
        ...
        if text.status == STARTED and not stimulus_pulse_started:
