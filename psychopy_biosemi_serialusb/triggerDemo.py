...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\lrcn_lab\\Documents\\Marc EEG demo\\triggerDemo.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/lrcn_lab/Desktop/triggers.xlsx'),
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() < 1.0:
        ...
        if text.status == STARTED and not stimulus_pulse_started:
            win.callOnFlip(port.write, str.encode(code))
